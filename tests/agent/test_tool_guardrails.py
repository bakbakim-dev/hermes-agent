...
def test_default_config_hard_stops_repeated_failures_by_default():
...
def test_soft_warning_mode_repeated_identical_failed_call_warns_without_blocking():
...
def test_same_tool_varying_args_warns_when_hard_stops_disabled():
    controller = ToolCallGuardrailController(
...
def test_idempotent_no_progress_repeated_result_warns_when_hard_stops_disabled():
    controller = ToolCallGuardrailController(
