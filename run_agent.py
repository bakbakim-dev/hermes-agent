...
def main(
    ...
    Args:
        ...
        model (str): Model name to use. Empty means resolve from Hermes config/environment.
        api_key (str): API key for authentication. Uses OPENROUTER_API_KEY env var if not provided.
        base_url (str): Base URL for the model API. Empty means resolve from Hermes config/environment.
